...
```
#json库
wget http://github.com/lloyd/yajl/tarball/1.0.12
...
#ngx_cephfs_readline 模块
git clone https://github.com/lidaohang/cephfs_readline.git
...
```
cd nginx-1.14.0
./configure --add-module=cephfs_readline 
make && make install
...
//配置文件nginx.conf
  server {
        ...
        location /v1/dss-cephfs/readfile {
	          cephfs_readline on;
        }
```
...
**效果**
```
curl 127.0.0.1:8012/v1/dss-cephfs/readfile -X POST -d  '{"poolname":"data","filename":"/mnt//business.log.2018101708","offset":19990595}'
{"code":0,"cost":51,"data":"[INFO][2018-10-17T08:59:49.018+0800] xxx"}
```
